...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY")# 'django-insecure-e3s!o_89r0_y35p65l*p*py(b0o2mm!p3!v(duy!!bc_pc7j_y'
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "config.utils.utils_exception.custom_exception_handler",
